...
*/
module.exports = function * match(propertyName, options, translator) {
  ...
  if (isDefined && (!matchPattern || (this._data.hasOwnProperty(propertyName) && !matchPattern.test(this._data[propertyName])))) {
