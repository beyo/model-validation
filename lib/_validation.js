...
module.exports.translator = messageTranslator;
...
function ModelValidator(model, rules, done) {
...
*/
function messageTranslator(callback) {
...
/**
A default translator, return message
*/
function defaultTranslator(message) { return message; };
